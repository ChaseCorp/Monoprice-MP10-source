...
#define DEFAULT_AXIS_STEPS_PER_UNIT    { 93, 93, 800, 97 }
#define Z_MIN_ENDSTOP_INVERTING true
#define ENDSTOPPULLUP_ZMIN
...
//#define STRING_CONFIG_H_AUTHOR "MALYAN SYSTEM BUILD 2018-02-20" // Who made the changes.
