...
#define STEP_TIMER_NUM TIM1
#define STEP_TIMER_CHAN 1 // Channel of the timer to use for compare and interrupts
#define TEMP_TIMER_NUM TIM3  // index of timer to use for temperature
...
#define ENABLE_STEPPER_DRIVER_INTERRUPT() TIM_ITConfig(TIM1,TIM_IT_Update,ENABLE)//timer_enable_irq(STEP_TIMER_DEV, STEP_TIMER_CHAN)
#define DISABLE_STEPPER_DRIVER_INTERRUPT() TIM_ITConfig(TIM1,TIM_IT_Update,DISABLE)//timer_disable_irq(STEP_TIMER_DEV, STEP_TIMER_CHAN)
#define STEPPER_ISR_ENABLED() ((TIM1->DIER & TIM_IT_Update)!=0)//HAL_timer_interrupt_enabled(STEP_TIMER_NUM)

#define ENABLE_TEMPERATURE_INTERRUPT() TIM_ITConfig(TIM3,TIM_IT_Update,ENABLE)//timer_enable_irq(TEMP_TIMER_DEV, TEMP_TIMER_CHAN)
#define DISABLE_TEMPERATURE_INTERRUPT() TIM_ITConfig(TIM3,TIM_IT_Update,DISABLE)//timer_disable_irq(TEMP_TIMER_DEV, TEMP_TIMER_CHAN)
