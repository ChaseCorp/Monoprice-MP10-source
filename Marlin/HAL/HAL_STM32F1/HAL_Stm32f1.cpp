...
void HAL_adc_init(void) {
  ...
  adc.startConversion();*/
    ...
    ADC_ChannelConfig(ADC1, ADC_Channel_0|ADC_Channel_4|ADC_Channel_TempSensor, ADC_SampleTime_239_5Cycles);
...
extern "C" void DMA1_Channel1_IRQHandler(void)
{
  ...
  if(DMA_GetITStatus(DMA1_IT_TC1) != RESET)
  {
    ...
    {
      adc_loop=0;
      HAL_adc_results[0] = AD_Value_avr[0];
      HAL_adc_results[1] = AD_Value_avr[1];
      HAL_adc_results[2] = AD_Value_avr[2]/4;
#if FAKE_TEMPERATURE
