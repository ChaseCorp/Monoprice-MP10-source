...
//extern void StartMainTask(void const * argument);
...
void init(void)
{
  ...
  if(HAL_ADC_Start_DMA(&hadc1, (uint32_t*)AD_Value, 3) != HAL_OK)
  {
...
static void MX_TIM10_Init(void)
{
  ...
  htim10.Init.Prescaler = 21-1;//((SystemCoreClock/40000000)-1);//21-1;
...
static void MX_TIM11_Init(void)
{
  ...
  htim11.Init.Period = 84000-1;//SystemCoreClock/1000;
...
extern void start_usart_dma(UART_HandleTypeDef *huart);
start_usart_dma(&huart1);
}
